...
public class MealServiceTest {
    ...
    @Test
    public void update() {
        Meal updated = getUpdatedMealUser();
        service.update(updated, USER_ID);
        assertMatchMeal(service.get(USER_MEAL_ID, USER_ID), getUpdatedMealUser());
    }

    @Test
    public void updateNotOwn() {
        assertThrows(NotFoundException.class, () -> service.update(meal1, ADMIN_ID));
        assertMatchMeal(service.get(USER_MEAL_ID, USER_ID), meal1);
    }
    ...
    public void getBetweenWithNullDates() {
        assertMatchMeal(service.getBetweenInclusive(null, null, USER_ID), meals);
    }
}