...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    @Test
    void validRegisterUser() throws Exception {
        UserTo userException = new UserTo(null, null, "newemail@ya.ru", "newPassword", 1500);
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(userException)))
                .andDo(print())
    ...
    void validUpdateUser() throws Exception {
        UserTo userException = new UserTo(USER_ID, null, "newemail@ya.ru", "newPassword", 1500);
