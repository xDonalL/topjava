...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    @Test
    void createValidException() throws Exception {
        Meal mealException = new Meal(null, null, "MealException", 200);

        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(mealException))
                .with(userHttpBasic(user)))
                .andDo(print())
                .andExpect(status().isUnprocessableEntity())
    ...
    void updateValidException() throws Exception {
        Meal mealException = new Meal(MEAL1_ID, null, "", 100);
